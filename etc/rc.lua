...
end}, {"manual", terminal .. " -e 'man awesome'"},
                       {"edit config", terminal .. " -e 'myeditor ~/.config/awesome/rc.lua'"}, {"arandr", "arandr"},
...
awful.util.mymainmenu = freedesktop.menu.build({
    ...
    after = {{"Terminal", terminal}, {"Log out", function()
        awesome.quit()
    end}, {"Sleep", "systemctl suspend"}, {"Restart", "systemctl reboot"}, {"Exit", "systemctl poweroff"}}
})
...
for i = 1, 9 do
    ...
    globalkeys = my_table.join(globalkeys, awful.key({modkey}, "#" .. i + 9, function()
...
awful.rules.rules = {{
    ...
    rule_any = {
        ...
        "Oblogout", "Peek", "Skype", "System-config-printer.py", "Sxiv", "Unetbootin.elf", "Wpa_gui", "pinentry",
