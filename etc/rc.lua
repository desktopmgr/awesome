...
beautiful.font = "Hack Nerd Font Regular 8"
...
local browser1 = "mybrowser"
local editor = "myeditor"
local editorgui = "myeditor"
local filemanager = "myfilemanager"
local mailclient = "myemail"
local mediaplayer = "music"
local scrlocker = "logout-menu"
local terminal = "myterminal"
local virtualmachine = "myvmmanager"
...
beautiful.init(string.format(gears.filesystem.get_configuration_dir() ..
                                 "/themes/%s/theme.lua", chosen_theme))
-- }}}
...
local myawesomemenu = {
    ...
    {"edit config", terminal .. " -e 'myeditor ~/.config/awesome/rc.lua'"},
...
end, {description = "mpc on/off", group = "widgets"}), awful.key({modkey}, "c",
                                                                 function()
...
awful.rules.rules = {
    ...
    {rule = {class = "Xfce4-settings-manager"}, properties = {floating = false}},
    {
        rule_any = {
            ...
            class = {
                "Arandr", "Blueberry", "Galculator", "Gnome-font-viewer",
                "Gpick", "Imagewriter", "Font-manager", "Kruler", "MessageWin", -- kalarm.
                "Oblogout", "Peek", "Skype", "System-config-printer.py", "Sxiv",
                "Unetbootin.elf", "Wpa_gui", "pinentry", "veromix",
                "xtightvncviewer"
            },
