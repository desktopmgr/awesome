...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202207032054-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.pro
# @@License          :  LICENSE.md
# @@ReadME           :  install.sh --help
# @@Copyright        :  Copyright: (c) 2023 Jason Hempstead, Casjays Developments
# @@Created          :  Friday, May 05, 2023 16:06 EDT
# @@File             :  install.sh
# @@Description      :  Install configurations for awesome
...
GLOBAL_OS_PACKAGES="awesome xterm sxhkd sxiv zathura firefox notify-send iwconfig catfish xfce4-terminal xfce4-power-manager xscreensaver conky tint2 xbindkeys lxappearance qt5ct rofi dmenu"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Run custom actions
__cmd_exists awesome && GLOBAL_OS_PACKAGES=""
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
